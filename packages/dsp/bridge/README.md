...
Swift App
    ↓
SoundBridgeDSPEngine (ObjC++)  ← This bridge layer
    ↓
soundbridge_dsp.h (C API)
    ↓
C++ DSP Engine
```
...
For Objective-C++/Swift integration tests, add host-app tests that call `SoundBridgeDSPEngine` directly.
