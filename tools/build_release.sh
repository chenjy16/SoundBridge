...
echo "Building SoundBridge Release (Universal Binary)"
echo "==============================================="
echo ""
...
echo "----------------------------------------"
echo ""
echo "App bundle: $PROJECT_ROOT/dist/SoundBridge.app"
echo ""
echo "Verify architectures:"
echo "  lipo -archs dist/SoundBridge.app/Contents/MacOS/SoundBridgeApp"
echo "  lipo -archs dist/SoundBridge.app/Contents/MacOS/SoundBridgeHost"
echo ""
echo "To test the app:"
echo "  open dist/SoundBridge.app"
echo ""
